                    ...
                    <div class="col-md-6" style="padding: 0;">
                        <div class="row" style="margin: 0;">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-4" style="padding: 0 5px;">
                                <div class="frappe-card" onclick="frappe.route_options={}; frappe.set_route('dak_task_list')" style="
                                    padding: 15px; 
                                    border-radius: 12px; 
                                ...
                                " onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">
                                    ...
                                    <h3 id="total-tasks-count" style="font-size: 1.5rem; font-weight: 700; margin-bottom: 0px; color: #ffffff;">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-4" style="padding: 0 5px;">
                                <div class="frappe-card" onclick="frappe.route_options={'status': 'Overdue'}; frappe.set_route('dak_task_list')" style="
                                    padding: 15px; 
                                    border-radius: 12px; 
                                    background: linear-gradient(135deg, #3d807a 0%, #5baaa4 100%);
                                ...
                                " onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">
                                    ...
                                    <h3 id="overdue-tasks-count" style="font-size: 1.5rem; font-weight: 700; margin-bottom: 0px; color: #ffffff;">
                                        <div class="skeleton" style="width: 30px; height: 24px; border-radius: 4px; display: inline-block;"></div>
                                    </h3>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-4" style="padding: 0 5px;">
                                <div class="frappe-card" onclick="frappe.route_options={'priority': 'High'}; frappe.set_route('dak_task_list')" style="
                                    padding: 15px; 
                                    border-radius: 12px; 
                                    background: linear-gradient(135deg, #3d807a 0%, #5baaa4 100%);
                                ...
                                " onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">
                                    ...
                                    <div style="position: absolute; bottom: 10px; right: 10px; width: 40px; height: 40px; background: linear-gradient(to bottom right, rgba(255,255,255,0.3), rgba(255,255,255,0)); border-radius: 50%;"></div>
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
                                        <h6 style="font-weight: 600; font-size: 0.8rem; opacity: 1; margin: 0; color: #ffffff; white-space: nowrap;">Urgent</h6>
                                        <span style="padding: 4px; border-radius: 6px;">
                                            <i class="fa fa-exclamation-circle" style="color: #ffffff; font-size: 0.8rem;"></i>
                                        </span>
                                    </div>
                                    <h3 id="high-priority-count" style="font-size: 1.5rem; font-weight: 700; margin-bottom: 0px; color: #ffffff;">
                                        <div class="skeleton" style="width: 30px; height: 24px; border-radius: 4px; display: inline-block;"></div>
                                    </h3>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-4" style="padding: 0 5px;">
                                <div class="frappe-card" onclick="frappe.route_options={'status': 'Pending Review'}; frappe.set_route('dak_task_list')" style="
                                    padding: 15px; 
                                    border-radius: 12px; 
                                    background: linear-gradient(135deg, #3d807a 0%, #5baaa4 100%);
                                ...
                                " onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">
                                    ...
                                    <h3 id="pending-review-count" style="font-size: 1.5rem; font-weight: 700; margin-bottom: 0px; color: #ffffff;">
                                        <div class="skeleton" style="width: 30px; height: 24px; border-radius: 4px; display: inline-block;"></div>
                                    </h3>
                                </div>
                            </div>
            ...
            <div class="drawer-body">
                ...
                <div id="drawer-step-1">
                    <div class="form-group">
                        ...
                        <div id="ctrl-customer" class="vibrant-link-field"></div>
                    </div>
                     <div class="form-group" style="margin-top: 20px;">
                        <label class="vibrant-label">Project</label>
                        <div id="ctrl-project" class="vibrant-link-field"></div>
                    </div>
                </div>
                ...
                <div id="drawer-step-3" style="display: none;">
                    <div class="form-group">
                        ...
                        <div id="ctrl-dependency" class="vibrant-link-field"></div>
                    </div>
                     <div class="form-group" style="margin-top: 20px;">
                        <label class="vibrant-label">Assigned To</label>
                        <div id="ctrl-assigned" class="vibrant-link-field"></div>
                    </div>
                     <div class="form-group" style="margin-top: 20px;">
                        <label class="vibrant-label">Share With</label>
                        <div id="ctrl-share-with" class="vibrant-link-field"></div>
                    </div>

                    <div style="margin-top: 20px;">
                        <label class="vibrant-label">Description</label>
                        <textarea class="vibrant-input" id="drawer-description" rows="5" placeholder="Add task details..."></textarea>
                    </div>
                </div>
            </div>
    ...
    frappe.call({
        ...
        callback: function (r) {
            if (!r.exc && r.message) {
                ...
                if (share_with) {
                    frappe.call({
                        ...
                        callback: function (res) {
                            frappe.show_alert({ message: `Task Created & Shared with ${share_with}`, indicator: 'green' });
                        }
                    });
                } else {
                ...
                if (page.controls && page.controls.dependency) page.controls.dependency.set_value('');
                if (page.controls && page.controls.assigned_to) page.controls.assigned_to.set_value('');
                if (page.controls && page.controls.share_with) page.controls.share_with.set_value('');
...
frappe.pages['dak_dashboard'].toggle_skeletons = function (show) {
    if (show) {
        // Stats
        $('#total-tasks-count').html('<div class="skeleton" style="height: 2.5rem; width: 40px; border-radius: 4px; display:inline-block;"></div>');
        $('#total-tasks-frappe-card').html('<div class="skeleton" style="height: 2.5rem; width: 40px; border-radius: 4px; display:inline-block;"></div>');
        $('#high-priority-count').html('<div class="skeleton" style="height: 2rem; width: 30px; border-radius: 4px; display:inline-block;"></div>');
        $('#overdue-tasks-count').html('<div class="skeleton" style="height: 2rem; width: 30px; border-radius: 4px; display:inline-block;"></div>');
        $('#pending-review-count').html('<div class="skeleton" style="height: 2rem; width: 30px; border-radius: 4px; display:inline-block;"></div>');

        // Matrix (Tasks)
        $('#perf-percent').html('<div class="skeleton" style="height: 1rem; width: 30px; border-radius: 4px;"></div>');
        $('#perf-completed').html('<div class="skeleton" style="height: 0.8rem; width: 50px; border-radius: 4px; margin-top: 2px;"></div>');

        // Matrix (Projects)
        $('#proj-perf-percent').html('<div class="skeleton" style="height: 1rem; width: 30px; border-radius: 4px;"></div>');
        $('#proj-perf-completed').html('<div class="skeleton" style="height: 0.8rem; width: 50px; border-radius: 4px; margin-top: 2px;"></div>');
        ...
        // Recent Activity
        $('#recent-activity-task .activity-text').html('<div class="skeleton skeleton-dark" style="height: 14px; width: 120px; margin-bottom: 4px;"></div>');
        $('#recent-activity-task .activity-time').html('<div class="skeleton skeleton-dark" style="height: 10px; width: 60px;"></div>');
        $('#recent-activity-project .activity-text').html('<div class="skeleton skeleton-dark" style="height: 14px; width: 120px; margin-bottom: 4px;"></div>');
        $('#recent-activity-project .activity-time').html('<div class="skeleton skeleton-dark" style="height: 10px; width: 60px;"></div>');
    }
};
    ...
    frappe.call({
        ...
        callback: function (r) {
            if (r.message) {
                ...
                $('#perf-completed').html(`${completed} <span style="font-size: 0.7rem; font-weight: 400; opacity: 0.7;">/ ${total}</span>`);
                $('#perf-circle').css('background', `conic-gradient(#425f5f 0% ${percent}%, rgba(255, 255, 255, 0.2) ${percent}% 100%)`);
                ...
                let percent_proj = total_proj > 0 ? Math.round((completed_proj / total_proj) * 100) : 0;

                $('#proj-perf-percent').text(percent_proj + '%');
                $('#proj-perf-completed').html(`${completed_proj} <span style="font-size: 0.7rem; font-weight: 400; opacity: 0.7;">/ ${total_proj}</span>`);
                $('#proj-perf-circle').css('background', `conic-gradient(#425f5f 0% ${percent_proj}%, rgba(255, 255, 255, 0.2) ${percent_proj}% 100%)`);
            }
        }
    });
    ...
    frappe.call({
        ...
        callback: function (r) {
            ...
            if (r.message && r.message.length > 0) {
                ...
                // Prepare Badges
                let priority_badge = `<span class="sphere-badge-pill" style="border-color: ${task.priority === 'High' ? '#ef5350' : '#ffa726'}">${task.priority}</span>`;
                ...
                <div class="decorative-sphere-card" style="cursor: pointer; padding: 25px 30px; gap: 0;" onclick="frappe.pages['dak_dashboard'].show_task_details('${task.name}')">
                    ...
                    <div class="card-content" style="flex: 2; padding-right: 20px; border-right: 1px solid rgba(255,255,255,0.1);">
                        <h3 onclick="event.stopPropagation(); frappe.pages['dak_dashboard'].show_task_details('${task.name}')" style="margin-top: 0;">${task.subject}</h3>
                        <p style="margin-bottom: 15px; opacity: 0.8;">${task.description || (task.name + " - " + (task.exp_end_date ? frappe.datetime.str_to_user(task.exp_end_date) : 'No Due Date'))}</p>
                        <div class="sphere-meta">
                            ${priority_badge}
                            ${status_badge}
                            <span class="sphere-badge-pill" style="border:none; opacity:0.8;">
                                <i class="fa fa-calendar" style="margin-right:5px;"></i> ${task.exp_end_date ? frappe.datetime.str_to_user(task.exp_end_date) : 'No Date'}
                            </span>
                        </div>
                    </div>
                ...
                container.html('<div class="alert alert-info">No active tasks found. <a href="#" onclick="frappe.pages[\'dak_dashboard\'].toggle_task_drawer(true)">Create one now</a>.</div>');
            }
        }
    });
};
...
frappe.pages['dak_dashboard'].drawer_next_step = function (targetStep) {
    if (!targetStep) targetStep = 2; // Default logic fallback

    // Current Step Validation
    if (targetStep === 2) {
        // Validation for step 1 if needed
    }
...
frappe.pages['dak_dashboard'].start_clock_interval = function () {
    ...
    frappe.pages['dak_dashboard'].timer.interval = setInterval(function () {
        ...
        $('#minuteBadge').text(totalMins + "m").css('display', 'flex');
    }, 1000);
};
        ...
        callback: function (r) {
            if (r.message) {
                ...
                if (r.message.task) {
                    ...
                    $('#recent-activity-task .activity-time').html(frappe.datetime.comment_when(r.message.task.creation));

                    // Update Click Handlers safely
                    $('#recent-activity-task')
                        .attr('onclick', null)
                        .off('click')
                        .on('click', function () { frappe.pages['dak_dashboard'].show_task_details(r.message.task.name); });
                ...
                if (r.message.project) {
                    ...
                    $('#recent-activity-project .activity-time').html(frappe.datetime.comment_when(r.message.project.creation));

                    // Update Click Handlers safely
                    $('#recent-activity-project')
                        .attr('onclick', null)
                        .off('click')
                        .on('click', function () { frappe.pages['dak_dashboard'].show_project_details(r.message.project.name); });
...
frappe.pages['dak_dashboard'].show_task_details = function (task_name) {
    frappe.db.get_doc('Task', task_name).then(task => {
        // Populate
        $('#detail-subject').text(task.subject);
        $('#detail-project').text(task.project || 'No Project');
        $('#detail-status').text(task.status);
        $('#detail-priority').text(task.priority);
        let prioColor = '#10b981'; // Low
        if (task.priority === 'Medium') prioColor = '#f59e0b';
        if (task.priority === 'High' || task.priority === 'Urgent') prioColor = '#dc2626';
        $('#detail-priority').css({ 'color': prioColor, 'border-color': prioColor });

        $('#detail-date').html(`<i class="fa fa-calendar"></i> ${task.exp_end_date ? frappe.datetime.str_to_user(task.exp_end_date) : 'No Date'}`);
        $('#detail-exp-time').text(task.expected_time || 0);
        $('#detail-description').text(task.description || 'No description provided.');

        // Assigned To
        let assigned_div = $('#detail-assigned');
        assigned_div.empty();
        if (task._assign) {
            let assigned_users = [];
            try {
                assigned_users = typeof task._assign === 'string' ? JSON.parse(task._assign) : task._assign;
            } catch (e) { }
        ...
        // Actions
        $('#btn-view-full-task').text('View Full Task').off('click').on('click', function () {
...
frappe.pages['dak_dashboard'].change_calendar_month = function (offset) {
    ...
    frappe.pages['dak_dashboard'].calendar_date = new Date(current.getFullYear(), current.getMonth() + offset, 1);
    frappe.pages['dak_dashboard'].render_mini_calendar();
};
...
frappe.pages['dak_dashboard'].render_mini_calendar = function () {
    ...
    if (!frappe.pages['dak_dashboard'].calendar_date) frappe.pages['dak_dashboard'].calendar_date = now;
    ...
    frappe.call({
        ...
        callback: function (r) {
            ...
            $('#mini-calendar-days').css({ 'display': 'grid', 'grid-template-columns': 'repeat(7, 1fr)', 'gap': '4px' });
            $('#mini-calendar-days').prev().css({ 'display': 'grid', 'grid-template-columns': 'repeat(7, 1fr)', 'gap': '4px' }).children().css('width', 'auto');
            ...
            for (let i = 1; i <= daysInMonth; i++) {
                ...
                let titleAttr = '';
                if (hasTasks) {
                    clickAction = `onclick="frappe.show_alert({message: '${dayTasks.length} tasks due on ${month} ${i}', indicator: 'orange'})"`;
...
frappe.pages['dak_dashboard'].show_project_details = function (project_name) {
    frappe.db.get_doc('Project', project_name).then(doc => {
        ...
        // Date
        $('#detail-date').html(`<i class="fa fa-calendar"></i> ${doc.expected_end_date ? frappe.datetime.str_to_user(doc.expected_end_date) : 'No Date'}`);
        ...
        // Actions
        $('#btn-view-full-task').text('View Full Project').off('click').on('click', function () {
